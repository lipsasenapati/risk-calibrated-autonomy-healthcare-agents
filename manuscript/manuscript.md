...
Archived version: {{ZENODO_DOI}} (commit {{CODE_COMMIT}})
...
archive. The preregistration is at {{PREREG_ID}}.
...
deposit as above ({{ZENODO_DOI}}), corresponding to commit {{CODE_COMMIT}}.
